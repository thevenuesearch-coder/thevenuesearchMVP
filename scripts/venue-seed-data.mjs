/**
 * Preserved snapshot of the venue data that used to live in
 * lib/data.ts as a hardcoded array. This file exists ONLY so
 * scripts/migrate-venues-to-supabase.mjs has the real venue
 * content (names, images, spaces) to migrate into Supabase.
 *
 * This is a one-time migration source, not something the app
 * imports at runtime — the app now reads venues from Supabase
 * via lib/venues.ts / /api/venues.
 */
