...
export function VenuePageClient({
   ...
   * app/venues/[id]/page.tsx (a Server Component, which also
   * powers this page's per-venue SEO metadata) and passed in
   * already resolved -- no loading state needed, and the page's
   * real content is present in the initial HTML rather than only
