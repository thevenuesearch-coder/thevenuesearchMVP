...
function ReviewPageContent() {
  ...
  const [draftChecked, setDraftChecked] =
    useState(false);
  ...
  useEffect(() => {
    ...
    const query =
      `venue=${venueId}&space=${selectedSpaceId}`;
                                    ...
                                    return night
                                      ...
                                      .map(
                                        (
                                          ...
                                          return (
                                            <tr
                                              key={`${night.date}-${selection.roomId}`}
                                            >
